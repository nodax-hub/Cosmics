...
const AboutUs = () => (
    <div id="aboutUs" className="aboutUs">
        <h2>О нас</h2>
        <p>Наш сервис предлагает уникальный опыт в мире комиксов, объединяя любителей и профессионалов. Мы стремимся
            сделать ваши любимые истории доступными и увлекательными.</p>
        <div className="team">
