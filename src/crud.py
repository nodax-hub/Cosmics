...
def get_comic_book_by_attribute(db: Session, skip: int = 0, limit: int = 100, **kwargs):
    return db.query(models.ComicBook).filter_by(**kwargs).offset(skip).limit(limit).all()
